...
void testIterator() 
{
	// nu stim reprezentarea MD, putem testa doar anumite lucruri generale, nu stim in ce ordine vor fi afisate elementele.
	MD m;
	...
	for (int i = 0; i < 100; i++) 
	{
		//adaug 100 de elemente, fiecare e cheia si valoarea 33
		m.adauga(33, 33);
	}
...
void testAllExtins() 
{
	cout << "Running testCreeaza...";
	testCreeaza();
	cout << "Done! \n";

	cout << "Running testAdauga...";
	testAdauga();
	cout << "Done! \n";

	cout << "Running testSterge...";
	testSterge();
	cout << "Done! \n";

	cout << "Running testIterator...";
	testIterator();
	cout << "Done! \n";

	cout << "Running testQuantity...";
	testQuantity();
	cout << "Done! \n";
}